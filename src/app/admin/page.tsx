    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Welcome back! Here&apos;s your event overview.</p>
        </div>
            ...
            <div className="space-y-4">
              {events.map((event) => (
                <Link
                  ...
                  className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-gold-500/30 transition-all group"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gold-500/20 to-gold-600/20 flex flex-col items-center justify-center">
                      <span className="text-xs text-gold-400 uppercase">
                  ...
                  <ArrowRight className="w-5 h-5 text-gray-600 group-hover:text-gold-400 transition-colors" />
                </Link>
              ))}
            </div>
          )}
