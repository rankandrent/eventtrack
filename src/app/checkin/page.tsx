              ...
              >
                <Card className="text-center">
                  <div className="p-8 space-y-6">
                    <div className="w-20 h-20 mx-auto bg-gradient-to-br from-gold-400 to-gold-600 rounded-2xl flex items-center justify-center">
                      <QrCode className="w-10 h-10 text-midnight-950" />
                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="relative">
                          ...
                          <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-midnight-900 text-gray-500">or</span>
                          </div>
                        </div>
                        ...
                        <form onSubmit={handleManualSubmit} className="space-y-3">
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:border-gold-500/50 focus:outline-none text-center font-mono"
                            value={manualCode}
                          ...
                          <>
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-white font-medium">{scanResult.event.name}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-white font-medium">{scanResult.event.venue}</p>
                              </div>
                            </div>
                          </>
                        )}
            ...
            >
              <Card>
                <div className="p-4 flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-400">Live Attendance</p>
                  ...
                  <div className="w-20 h-20 relative">
                    <svg className="w-full h-full transform -rotate-90">
                      ...
                      <circle
                        ...
                        strokeDasharray={`${(stats.checkedIn / stats.total) * 226} 226`}
                        strokeLinecap="round"
                      />
                    </svg>
